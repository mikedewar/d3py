...
class TestVega(object):
    ...
    def setup(self):
        ...
        self.test_default = vega.Vega()
        self.test_inputs = vega.Vega(name='test', width=800, height=400,
    ...
    def test_atts(self):
        ...
        assert self.test_default.padding == {'top': 10, 'left': 30, 
                                             'bottom': 20, 'right': 10}
        assert self.test_default.viewport == []
    ...
    def test_build(self):
        ...
        keys = ['name', 'width', 'height', 'padding', 'viewport', 'data', 
                'scales', 'axes', 'marks']
        for key in keys: 
            self.test_default._build_vega(key)
    ...
    def test_update(self):
        ...
        self.test_default.update_vega('name'='newname', 'width'=500, 
                                      'height'=1000)
        assert self.test_default.vega['name'] == 'newname'
        assert self.test_default.vega['width'] == 500
        assert self.test_default.vega['height'] == 1000
